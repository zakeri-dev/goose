...
const i18n = defineMessages({
  ...
  importNostrDesc: { id: 'sessions.importNostr.description', defaultMessage: 'Paste a SOHA Nostr share link to fetch, decrypt, and import the session.' },
  ...
  chatHistoryDesc: { id: 'sessions.chatHistoryDesc', defaultMessage: 'View and search your past conversations with SOHA. {shortcut} to search.' },
